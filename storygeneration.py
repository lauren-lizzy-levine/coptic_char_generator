...
from storygeneration_RNN import RNN
...
file_handler = logging.FileHandler("log/storygeneration_logs.log")
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--train", required=True, help="True to train the model", action="store_true")
    parser.add_argument(
    ...
    logger.info(f"end TokLM -- {datetime.datetime.now()}")
